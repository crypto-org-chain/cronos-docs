...
* **Minted**, e.g. Token created by the [mint](https://github.com/lezzokafka/cronos-docs/blob/cronos\_git\_book/docs/chain-details/module\_mint/README.md) module; or
* **Burned**, e.g. Token distorted by the [slashing](https://github.com/lezzokafka/cronos-docs/blob/cronos\_git\_book/docs/chain-details/module\_slashing/README.md) module.

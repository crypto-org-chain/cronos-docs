...
*   Update the `To Account` address to your desired wallet address
    ...
    ![](./assets/cronos-gamefi-integration-step6-2.png)
...
1. Switch to WebGL platform\
   &#x20;![](./assets/cronos-gamefi-integration-step8-1.png)
2. Click the `Player Setting` button
3. Select `Web3GL-2020` under `Resolution and Presentation` tab ![](./assets/cronos-gamefi-integration-step8-2.png)
4. Set `Compression Format` to `Disabled` under `Publishing Settings` tab ![](./assets/cronos-gamefi-integration-step8-3.png)
5. After that, click `Build and Run` button and you are ready to play. ![](./assets/cronos-gamefi-integration-step8-4.png)
...
![](./assets/cronos-gamefi-integration-step5-1.png)

```
-  Approve the connection
```

![](./assets/cronos-gamefi-integration-step5-2.png)

```
-  Select your contract name under CONTRACT tab
```

![](./assets/cronos-gamefi-integration-step5-3.png)

```
-  Approve the transaction after clicking `Deploy` button
```

![](./assets/cronos-gamefi-integration-step5-4.png)
...
* Step 1. Connect your wallet via metamask or walletconnect ![](./assets/cronos-gamefi-integration-nft-fauct-1.png)
* Step 2. Click `Create NFT` under `YOUR COLLECTION` tab ![](./assets/cronos-gamefi-integration-nft-fauct-2.png)
* Step 3. Create and sign the transaction after uploading the image ![](./assets/cronos-gamefi-integration-nft-fauct-3.png)
* Step 4. Copy the contract address and image URL from the NFT modal ![](./assets/cronos-gamefi-integration-nft-fauct-4.png)
* Step 5. Paste into the corresponding input box inside Unity inspector ![](./assets/cronos-gamefi-integration-step6-2.png)

***

### (Optional) List NFT for sale in marketplace faucet

* Step 1. Fill in the price at list item modal and confirm ![](./assets/cronos-gamefi-integration-nft-fauct-5.png)
* Step 2. Sign approval and create item transaction ![](./assets/cronos-gamefi-integration-nft-fauct-6.png) ![](./assets/cronos-gamefi-integration-nft-fauct-7.png)
* Step 3. View the listed item in Marketplace tab \
  ![](./assets/cronos-gamefi-integration-nft-fauct-8.png)

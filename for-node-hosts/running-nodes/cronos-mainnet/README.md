...
| --------------------- | --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `1 ~ 2,693,800`       | [`cronos_v0.6.*`](https://github.com/crypto-org-chain/cronos/releases?page=3)     | <p>Start the node with the older binary version <a href="https://github.com/crypto-org-chain/cronos/releases?page=3"><code>cronos_v0.6.*</code></a><br><br>Sync-up with the blockchain until it reaches the target upgrade block height <code>2,693,800</code></p>                                                                                        |
| `2,693,800 ~ 3982500` | [`cronos_v0.7.0`](https://github.com/crypto-org-chain/cronos/releases/tag/v0.7.0) | <p>After it reaches the block height <code>2,693,800</code>, update <code>app.toml</code> with <a href="https://github.com/crypto-org-chain/cronos/releases/tag/v0.7.0">new config items</a><br><br>Update the binary to <a href="https://github.com/crypto-org-chain/cronos/releases/tag/v0.7.0"><code>cronos_v0.7.0</code> </a><br>Restart the node</p> |
| `3982500`             | [`cronos_v0.8.3`](https://github.com/crypto-org-chain/cronos/releases/tag/v0.8.3) | <p>After reaching block height, update <a href="https://github.com/crypto-org-chain/cronos/releases/tag/v0.8.2"><code>iavl-disable-fastnode</code></a><code>in app.toml</code><br><br>Update the binary to <a href="https://github.com/crypto-org-chain/cronos/releases/tag/v0.8.3"><code>cronos_v0.8.3</code></a><br>Restart the node</p>                |
| `6542800`             | [`cronos_v1.0.2`](https://github.com/crypto-org-chain/cronos/releases/tag/v1.0.2) | <p>After reaching block height, update <a href="https://github.com/crypto-org-chain/cronos/releases/tag/v1.0.2"><code>app-db-backend</code></a>in app.toml. <br><br>Update the binary to <code>cronos_v1.0.2</code><br>Restart the node</p>                                                                                                               |

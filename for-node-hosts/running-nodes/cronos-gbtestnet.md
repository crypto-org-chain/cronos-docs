...
| `991350`     | [v0.8.0-gravity-alpha1-patch](https://github.com/crypto-org-chain/cronos/releases/tag/v0.8.0-gravity-alpha1-patch) | <p>After it reaches the block height <code>991350</code>, update the binary to <a href="https://github.com/crypto-org-chain/cronos/releases/tag/v0.8.0-gravity-alpha1-patch">v0.8.0-gravity-alpha1-patch</a>;</p><p></p><p>Start the node again</p>                                                                                                                                                                                                                                                                                                                           |
| `1995388`    | [v0.8.0-gravity-alpha2](https://github.com/crypto-org-chain/cronos/releases/tag/v0.8.0-gravity-alpha2)             | <p>After it reaches the block height <code>1995388</code>, update the binary to <a href="https://github.com/crypto-org-chain/cronos/releases/tag/v0.8.0-gravity-alpha2">v0.8.0-gravity-alpha2</a>;</p><p></p><p>Start the node again</p>                                                                                                                                                                                                                                                                                                                                      |
| `2083888`    | [v0.8.0-gravity-alpha3](https://github.com/crypto-org-chain/cronos/releases/tag/v0.8.0-gravity-alpha3)             | <p>After it reaches the block height <code>2083888</code>, update the binary to <a href="https://github.com/crypto-org-chain/cronos/releases/tag/v0.8.0-gravity-alpha3">v0.8.0-gravity-alpha3</a>;</p><p></p><p>Start the node again</p>                                                                                                                                                                                                                                                                                                                                      |

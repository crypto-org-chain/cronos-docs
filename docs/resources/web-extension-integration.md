...
:::tip Note `DeFiWeb3Connector` has implement `AbstractConnector` from `web3-react` :::
...
The following git folder will provide you with some basic deficonnect integrations via react and web3modal. :::tip Note You need to replace `INFURA_API_KEY` with a key generated at [Infura](https://infura.io/) :::
